...
the source data, lagging it by seconds instead of a batch cycle. A subtlety that matters:
...
the old one have a meaningless similarity. The instant you upgrade the embedding model, every
