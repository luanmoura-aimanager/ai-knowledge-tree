...
can do with it. The [pipeline](I1/pipeline-paradigms) feeds one of three storage
...
where you want it, and time travel to query past versions. You get warehouse-grade
