...
set of nodes that are replicated, annotated with the replication index.
...
The rule is direct: for each node in the plate, write one factor per plate iteration.
