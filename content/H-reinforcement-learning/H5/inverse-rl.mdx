...
f_e = pi_e @ F                              # expert feature expectation

# Fact 1: the feature-matching gradient is zero at the true theta.
grad = f_e - softmax(F @ theta_true) @ F
...
print("grad norm:", round(float(np.linalg.norm(grad)), 8),
