...
$\tilde{z}$ with reward $0$, before reaching the $r = 2$ latent. Show that if
the value targets are computed correctly, both models give the same value
$V(s_0)$, illustrating value equivalence.
