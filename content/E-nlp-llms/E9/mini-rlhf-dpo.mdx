...
runs the smallest faithful version of [Direct Preference Optimization](/pillar/E/E4/dpo) on
the tiny GPT: a reference copy, a handful of preference pairs, and one gradient step on the
DPO loss.
