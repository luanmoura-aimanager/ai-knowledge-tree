...
The LSTM (Hochreiter and Schmidhuber, 1997) maintains two vectors per time step:
...
The GRU (Cho et al., 2014) is a simplified LSTM that merges cell and hidden states and
