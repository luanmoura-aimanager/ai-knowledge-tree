...
a nontrivial fact). The **nullity** is $\dim\operatorname{null}(A)$.

## Rank–nullity theorem

**Theorem.** For any $A \in \mathbb{R}^{m \times n}$,
...
vector is numerically orthogonal to every row. The next lesson builds a ruler for
