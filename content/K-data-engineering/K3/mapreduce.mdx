...
programmer, handles partitioning, scheduling, and failures. The phases are **map**
...
occurrence" down to "one record per distinct word per mapper", often a large reduction.
