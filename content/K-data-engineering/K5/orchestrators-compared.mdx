...
you drew. The DAG is **imperative**: it says *do this, then that*. What a task reads or
...
tasks move. The asset-centric model trades some of that generality (everything is
