...
rescues underflowing gradients; bf16 has the same approximation error
but doesn't need loss scaling because of its wider exponent range. The
next lesson handles a different memory tradeoff: gradient checkpointing.
