...
unconstrained: a user embedding can subtract one feature from another, and
...
the data. The interpretability comes essentially for free.
...
Lee and Seung's classic algorithm: alternate two element-wise updates that
