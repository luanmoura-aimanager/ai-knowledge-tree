...
(**Hu-Koren-Volinsky**, 2008) addresses both.
...
where $i^+$ is observed and $i^-$ is sampled negative. The loss maximizes
...
probability. The next lesson tightens the model to nonneg factors with NMF.
