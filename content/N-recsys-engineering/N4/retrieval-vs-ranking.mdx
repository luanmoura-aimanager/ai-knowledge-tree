...
funnel is the backbone architecture of every large-scale recommender<FN n="1" />, and this
...
index returns the top $k$ in sublinear time<FN n="2" />. The ranker is expensive because it
