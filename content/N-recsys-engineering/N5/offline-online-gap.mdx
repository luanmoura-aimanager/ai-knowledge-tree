...
feedback used to evaluate its future decisions<FN n="1" />. The result is **exposure bias**: the
...
offline and online disagree<FN n="2" />. And treat offline metrics as a *filter* that removes
