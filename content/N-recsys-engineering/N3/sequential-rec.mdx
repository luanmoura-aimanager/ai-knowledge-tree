...
This rounds out deep retrieval; from here the recommender-systems pillar turns to
ranking, evaluation, and the serving infrastructure that puts these models in
production. The approximate-nearest-neighbor indexes that let embedding retrieval
serve at scale are covered back in C8.
