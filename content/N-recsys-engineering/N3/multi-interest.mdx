...
$\mathbf{c}_2 = (0, 1)$. Compute the single-vector summary
$\frac{1}{2}(\mathbf{c}_1 + \mathbf{c}_2)$ and its dot product with a
$\mathbf{c}_1$-aligned item $(1, 0)$, then compare to the multi-interest max score.
