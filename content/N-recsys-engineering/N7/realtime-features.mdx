...
recommender respond *within* a session rather than to yesterday's behavior<FN n="2" />. This lesson
...
the serving path reads it<FN n="1" />. The same definition must still match the offline training
