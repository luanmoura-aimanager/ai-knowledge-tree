    ...
    subs: [
      ...
      },
      {
        ...
        topics: [
          ...
          { name: "SwiGLU / GeGLU gated FFNs", status: "gap" },
          {
      ...
      },
      {
        ...
        topics: [
          ...
          { name: "Residual stream view", status: "gap" },
          { name: "Emergent abilities (debated)", status: "gap", hot: true },
        ],
      },
      {
        id: "E9",
        name: "Capstone: build a tiny GPT",
        intro:
          "The capstone closes the pillar by building a working language model end to end, the way nanoGPT does: a small decoder-only Transformer trained on character-level text. Everything taught across A, C, D, and E reappears here as code that runs, so the abstractions become a model you can train on a laptop and sample from.\n\nYou will set up the training loop and data pipeline, reimplement the Transformer block from scratch, and train it on TinyShakespeare. Then you will modernize it with RoPE and RMSNorm, add a minimal preference-tuning pass (RLHF/DPO) on top of the pretrained base, and finish by re-reading 'Attention Is All You Need' with the implementation in hand.\n\nThis subsection is deliberately a synthesis: it has no new theory of its own. It exists so the reader can verify, by building, that the pieces fit together.",
        prerequisites: [
          "E3 Transformer LMs (the block, positional encodings, decoder-only).",
          "E4 Training LLMs (pretraining objective) and E4/E? alignment for the DPO pass.",
          "D1 Core building blocks (backprop, optimizers) and comfortable PyTorch.",
        ],
        topics: [
          { name: "nanoGPT setup & data pipeline", status: "gap" },
          { name: "Transformer block from scratch", status: "gap" },
          { name: "Train on TinyShakespeare", status: "gap" },
          { name: "RoPE + RMSNorm upgrade", status: "gap", hot: true },
          { name: "Mini RLHF / DPO pass", status: "gap", hot: true },
          { name: "Attention Is All You Need, revisited", status: "gap" },
        ],
      },
    ],
  },
    ...
    subs: [
      {
        ...
        topics: [
          ...
          { name: "Feature engineering & encoding", status: "gap" },
      ...
      },
      {
        ...
        topics: [
          ...
          { name: "Model registry & CI/CD for ML", status: "gap" },
      ...
      },
      {
        ...
        topics: [
          ...
          {
            name: "Deployment strategies (canary, shadow, blue-green)",
            status: "gap",
          },
      ...
      },
      {
        ...
        topics: [
          ...
          { name: "Automated retraining & continual learning", status: "gap" },
...
export const CONNECTIONS: Connection[] = [
  ...
  // ---- E9. Capstone synthesizes the spine ----
  { from: "E9", to: "E3", label: "Capstone builds the block", kind: "uses" },
  { from: "E9", to: "D1", label: "Backprop + optimizers", kind: "uses" },
  { from: "E9", to: "E4", label: "Pretraining + DPO pass", kind: "uses" },
  { from: "E9", to: "E5", label: "Autoregressive generation", kind: "uses" },
...
export const PATHS: Path[] = [
  {
    ...
    steps: [
      ...
      { subId: "A1", lessonId: "vector-spaces", note: "0.1" },
      { subId: "A1", lessonId: "matrix-calculus", note: "0.2–0.3" },
      { subId: "A2", lessonId: "random-variables", note: "0.4" },
      { subId: "A2", lessonId: "bayes-rule", note: "0.5" },
      { subId: "A2", lessonId: "entropy", note: "0.6" },
      { subId: "A2", lessonId: "kl-cross-entropy", note: "0.6" },
      { subId: "A2", lessonId: "mle", note: "0.7" },
      { subId: "A3", lessonId: "convex-functions", note: "0.8" },
      { subId: "D1", lessonId: "activations", note: "0.9" },
      { subId: "A4", lessonId: "log-sum-exp", note: "0.10" },
      // Ch1 — Linear models & the perceptron
      { subId: "C1", lessonId: "linear-regression-mle", note: "1.1" },
      { subId: "C1", lessonId: "logistic-regression", note: "1.2" },
      { subId: "A3", lessonId: "gradient-descent", note: "1.3" },
      { subId: "C2", lessonId: "hard-margin-svm", note: "1.4" },
      { subId: "C2", lessonId: "perceptron", note: "1.5" },
      { subId: "D1", lessonId: "universal-approximation", note: "1.6" },
      { subId: "C1", lessonId: "softmax-regression", note: "1.7–1.8" },
      // Ch2 — MLPs & backprop
      { subId: "D1", lessonId: "mlp-forward", note: "2.1–2.4" },
      { subId: "D1", lessonId: "backprop", note: "2.5–2.8" },
      { subId: "D1", lessonId: "initialization", note: "2.9–2.10" },
      { subId: "D1", lessonId: "autodiff", note: "2.11–2.12" },
      // Ch3 — Optimization & regularization
      { subId: "A3", lessonId: "sgd", note: "3.1" },
      { subId: "A3", lessonId: "momentum", note: "3.3" },
      { subId: "A3", lessonId: "adaptive-methods", note: "3.2, 3.4–3.5" },
      { subId: "D1", lessonId: "dl-optimizers", note: "3.6–3.7" },
      { subId: "D1", lessonId: "normalization", note: "3.8, 3.C" },
      { subId: "D1", lessonId: "regularization", note: "3.A–3.B" },
      // Ch4 — CNN bridge
      { subId: "D2", lessonId: "convolution", note: "4.1–4.C" },
      // Ch5 — Sequence modeling & embeddings
      { subId: "E1", lessonId: "tokenization", note: "5.1" },
      { subId: "E2", lessonId: "word2vec", note: "5.2" },
      { subId: "E1", lessonId: "ngram-lm", note: "5.3–5.4" },
      { subId: "E2", lessonId: "rnn-lm", note: "5.5" },
      { subId: "D3", lessonId: "rnn", note: "5.6" },
      { subId: "E2", lessonId: "lstm-gru", note: "5.A" },
      // Ch6 — Attention & the Transformer
      { subId: "E3", lessonId: "self-attention", note: "6.1–6.2" },
      { subId: "E3", lessonId: "multi-head-attention", note: "6.3–6.5" },
      { subId: "E3", lessonId: "positional-encodings", note: "6.6–6.7" },
      { subId: "E3", lessonId: "transformer-block", note: "6.8–6.11, 6.15" },
      { subId: "D3", lessonId: "linear-attention", note: "6.12–6.13" },
      { subId: "E5", lessonId: "kv-cache", note: "6.14" },
      // Ch7 — Training language models
      { subId: "E4", lessonId: "pretraining-data", note: "7.1, 7.5" },
      { subId: "E1", lessonId: "tokenization", note: "7.2 (BPE)" },
      { subId: "D7", lessonId: "training-infrastructure", note: "7.3" },
      { subId: "D7", lessonId: "mixed-precision-dl", note: "7.4" },
      { subId: "D7", lessonId: "data-parallel", note: "7.6, 7.8, 7.10" },
      { subId: "D7", lessonId: "gradient-checkpointing", note: "7.7" },
      { subId: "D7", lessonId: "model-parallel", note: "7.9" },
      { subId: "E4", lessonId: "scaling-laws", note: "7.11–7.12, 7.14" },
      {
        subId: "E3",
        lessonId: "positional-encodings",
        note: "7.13 (long context)",
      },
      // Ch8 — Modern LLM architectures
      { subId: "E3", lessonId: "decoder-only", note: "8.1" },
      { subId: "E3", lessonId: "encoder-only", note: "8.2" },
      { subId: "E3", lessonId: "gqa-moe", note: "8.3, 8.6" },
      { subId: "E3", lessonId: "swiglu-geglu", note: "8.4" },
      { subId: "E3", lessonId: "mla", note: "8.5" },
      { subId: "D3", lessonId: "state-space-models", note: "8.7" },
      { subId: "D3", lessonId: "hybrid-architectures", note: "8.8" },
      { subId: "E3", lessonId: "encoder-decoder", note: "8.A (T5)" },
      // Ch9 — Alignment
      { subId: "E4", lessonId: "sft", note: "9.1–9.2" },
      { subId: "E4", lessonId: "reward-modeling", note: "9.3–9.4" },
      {
        subId: "H6",
        lessonId: "rl-as-llm-finetuning",
        note: "9.x (RL framing)",
      },
      { subId: "H2", lessonId: "policy-gradient", note: "9.5" },
      { subId: "E4", lessonId: "ppo-rlhf", note: "9.6, 9.8–9.9" },
      { subId: "E4", lessonId: "grpo", note: "9.7" },
      { subId: "E4", lessonId: "dpo", note: "9.10–9.11" },
      { subId: "E6", lessonId: "test-time-compute", note: "9.12 (PRMs)" },
      { subId: "E4", lessonId: "rlaif", note: "9.13" },
      { subId: "H6", lessonId: "reward-hacking", note: "9.14" },
      { subId: "E5", lessonId: "decoding", note: "9.15 (inference-time)" },
      // Ch10 — Inference & decoding
      { subId: "E5", lessonId: "decoding", note: "10.1–10.2" },
      { subId: "E5", lessonId: "kv-cache", note: "10.3" },
      { subId: "E5", lessonId: "speculative-decoding", note: "10.4" },
      { subId: "D7", lessonId: "flash-attention", note: "10.5" },
      { subId: "E5", lessonId: "quantization", note: "10.6" },
      { subId: "E6", lessonId: "test-time-compute", note: "10.7" },
      { subId: "E5", lessonId: "paged-attention", note: "10.8" },
      { subId: "E6", lessonId: "react-agents", note: "10.9 (agentic)" },
      // Ch11 — Interpretability & the frontier
      { subId: "E8", lessonId: "probing", note: "11.1" },
      { subId: "E8", lessonId: "residual-stream", note: "11.2" },
      { subId: "E8", lessonId: "circuits", note: "11.1, 11.3" },
      { subId: "E8", lessonId: "induction-heads", note: "11.4" },
      { subId: "E8", lessonId: "superposition", note: "11.5" },
      { subId: "E8", lessonId: "sparse-autoencoders", note: "11.6" },
      { subId: "E8", lessonId: "activation-steering", note: "11.7" },
      { subId: "E8", lessonId: "emergent-abilities", note: "11.8" },
      { subId: "E8", lessonId: "frontier-now", note: "11.9" },
      // Ch12 — Capstone: build a tiny GPT
      { subId: "E9", lessonId: "nanogpt-setup", note: "6.16, 12.1" },
      { subId: "E9", lessonId: "transformer-block-from-scratch", note: "12.2" },
      { subId: "E9", lessonId: "train-tinyshakespeare", note: "12.3" },
      { subId: "E9", lessonId: "rope-rmsnorm", note: "12.4" },
      { subId: "E9", lessonId: "mini-rlhf-dpo", note: "12.5" },
      { subId: "E9", lessonId: "aiayn-revisited", note: "12.6" },
    ],
  },
  {
    name: "🎓 LLM Researcher",
    desc: "Classic LLM spine: math → DL → Transformers → alignment.",
    pillars: ["A2", "A3", "D1", "D3", "E3", "E4", "H6", "E8"],
    color: "var(--pe)",
    steps: [
      { subId: "A2", lessonId: "bayes-rule", section: "Math foundations" },
      {
        subId: "A2",
        lessonId: "kl-cross-entropy",
        section: "Math foundations",
      },
      { subId: "A2", lessonId: "mle", section: "Math foundations" },
      {
        subId: "A3",
      ...
      { subId: "D1", lessonId: "backprop", section: "Deep learning core" },
      { subId: "D1", lessonId: "normalization", section: "Deep learning core" },
      { subId: "D3", lessonId: "rnn", section: "Deep learning core" },
      {
        subId: "D3",
        lessonId: "self-attention",
        section: "Deep learning core",
      },
      {
        subId: "E3",
      ...
      { subId: "E3", lessonId: "decoder-only", section: "The Transformer" },
      {
        subId: "E4",
        lessonId: "scaling-laws",
        section: "Training & alignment",
      },
      { subId: "E4", lessonId: "sft", section: "Training & alignment" },
      {
        subId: "E4",
      ...
      { subId: "E4", lessonId: "ppo-rlhf", section: "Training & alignment" },
      { subId: "E4", lessonId: "dpo", section: "Training & alignment" },
      { subId: "E8", lessonId: "circuits", section: "Interpretability" },
      {
        subId: "E8",
  ...
  },
  {
    ...
    steps: [
      ...
      { subId: "E6", lessonId: "advanced-rag", section: "Retrieval & agents" },
      {
        subId: "E6",
        lessonId: "function-calling",
        section: "Retrieval & agents",
      },
      { subId: "E6", lessonId: "react-agents", section: "Retrieval & agents" },
      { subId: "J1", lessonId: "rag-from-scratch", section: "Build it" },
      { subId: "J1", lessonId: "tool-use", section: "Build it" },
      { subId: "J1", lessonId: "react-loop", section: "Build it" },
      { subId: "J1", lessonId: "agent-frameworks", section: "Build it" },
      {
        subId: "J1",
        lessonId: "langgraph-state-machines",
        section: "Build it",
      },
      { subId: "J2", lessonId: "mcp-protocol", section: "Protocols & eval" },
      {
        subId: "J2",
        lessonId: "designing-mcp-servers",
        section: "Protocols & eval",
      },
      { subId: "J2", lessonId: "production-rag", section: "Protocols & eval" },
      { subId: "J2", lessonId: "llm-as-judge", section: "Protocols & eval" },
      { subId: "J3", lessonId: "serving-api-design", section: "Production" },
      { subId: "J3", lessonId: "deployment-cicd", section: "Production" },
      { subId: "J3", lessonId: "observability-tracing", section: "Production" },
      {
        subId: "J3",
      ...
      { subId: "J5", lessonId: "data-contracts", section: "Data platform" },
      { subId: "J5", lessonId: "vector-infra-ann", section: "Data platform" },
      { subId: "J5", lessonId: "hybrid-search-rrf", section: "Data platform" },
      {
        subId: "J6",
  ...
  },
  {
    ...
    steps: [
      ...
      { subId: "E6", lessonId: "dense-retrieval", section: "RAG & retrieval" },
      { subId: "E6", lessonId: "advanced-rag", section: "RAG & retrieval" },
      {
        subId: "E6",
        lessonId: "function-calling",
        section: "Tool use & reasoning",
      },
      {
        subId: "E6",
      ...
      { subId: "E6", lessonId: "multi-agent", section: "Tool use & reasoning" },
      { subId: "J1", lessonId: "react-loop", section: "Build agents" },
      { subId: "J1", lessonId: "agent-frameworks", section: "Build agents" },
      {
        subId: "J1",
        lessonId: "langgraph-state-machines",
        section: "Build agents",
      },
      { subId: "J2", lessonId: "mcp-protocol", section: "MCP & orchestration" },
      {
        subId: "J2",
        lessonId: "designing-mcp-servers",
        section: "MCP & orchestration",
      },
      {
        subId: "J4",
        lessonId: "multi-agent-orchestration",
  ...
  },
  {
    ...
    steps: [
      ...
      { subId: "I4", lessonId: "production-drift", section: "Monitoring" },
      { subId: "I4", lessonId: "llm-evaluation", section: "Monitoring" },
      {
        subId: "I4",
        lessonId: "safety-evals-red-teaming",
        section: "Monitoring",
      },
      { subId: "I4", lessonId: "cost-monitoring", section: "Monitoring" },
      {
        subId: "J7",
        lessonId: "ai-governance-compliance",
        section: "Governance",
      },
      { subId: "J7", lessonId: "red-teaming-at-scale", section: "Governance" },
      {
        subId: "J7",
  ...
  },
  {
    ...
    steps: [
      ...
      { subId: "A2", lessonId: "mle", section: "Probability & estimation" },
      {
        subId: "B1",
      ...
      { subId: "B4", lessonId: "ab-testing", section: "Experiments" },
      { subId: "B4", lessonId: "power-analysis", section: "Experiments" },
      { subId: "B4", lessonId: "cuped", section: "Experiments" },
      { subId: "B4", lessonId: "multi-armed-bandits", section: "Experiments" },
      {
        subId: "B5",
        lessonId: "potential-outcomes",
        section: "Causal inference",
      },
      { subId: "B5", lessonId: "scm-dags", section: "Causal inference" },
      { subId: "B5", lessonId: "do-calculus", section: "Causal inference" },
      {
        subId: "B5",
        lessonId: "propensity-scores",
        section: "Causal inference",
      },
      { subId: "B5", lessonId: "iv-estimation", section: "Causal inference" },
      { subId: "B5", lessonId: "diff-in-diff", section: "Causal inference" },
      { subId: "B5", lessonId: "double-ml", section: "Causal inference" },
      {
        subId: "G5",
        lessonId: "granger-causality",
        section: "Causal over time",
      },
      {
        subId: "G5",
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        section: "Feature & data engineering",
      },
      {
        subId: "I1",
      ...
      { subId: "I2", lessonId: "ml-cicd", section: "Experiment & train" },
      { subId: "D7", lessonId: "data-parallel", section: "Experiment & train" },
      {
        subId: "I3",
        lessonId: "latency-throughput",
        section: "Package & deploy",
      },
      {
        subId: "I3",
      ...
      { subId: "I3", lessonId: "quantization", section: "Package & deploy" },
      { subId: "E5", lessonId: "kv-cache", section: "Serve" },
      { subId: "I3", lessonId: "llm-serving", section: "Serve" },
      {
        subId: "I4",
        lessonId: "slos-and-error-budgets",
        section: "Monitor & retrain",
      },
      {
        subId: "I4",
  ...
  },
  {
    ...
    pillars: ["D3", "D4", "D7", "E4", "H6", "E6", "J2", "E8"],
    color: "var(--pf)",
    steps: [
      {
        subId: "D3",
      ...
      { subId: "D4", lessonId: "diffusion", section: "Generative modeling" },
      {
        subId: "D4",
      ...
      { subId: "D7", lessonId: "data-parallel", section: "Scaling & training" },
      { subId: "E4", lessonId: "scaling-laws", section: "Scaling & training" },
      { subId: "E4", lessonId: "grpo", section: "Reasoning & RL" },
      { subId: "H6", lessonId: "rlvr-reasoning", section: "Reasoning & RL" },
      { subId: "H6", lessonId: "reward-hacking", section: "Reasoning & RL" },
      { subId: "E6", lessonId: "test-time-compute", section: "Reasoning & RL" },
      { subId: "E6", lessonId: "react-agents", section: "Agents & frontier" },
      { subId: "J2", lessonId: "mcp-protocol", section: "Agents & frontier" },
      { subId: "E8", lessonId: "superposition", section: "Agents & frontier" },
      {
        subId: "E8",
        lessonId: "sparse-autoencoders",
        section: "Agents & frontier",
      },
      { subId: "E8", lessonId: "frontier-now", section: "Agents & frontier" },
    ],
  },
  {
    ...
    color: "var(--pd)",
    steps: [
      { subId: "D1", lessonId: "mlp-forward", section: "Deep learning core" },
      { subId: "D1", lessonId: "backprop", section: "Deep learning core" },
      { subId: "D1", lessonId: "normalization", section: "Deep learning core" },
      { subId: "D2", lessonId: "convolution", section: "Convolutional vision" },
      {
        subId: "D2",
        lessonId: "cnn-architectures",
        section: "Convolutional vision",
      },
      { subId: "D2", lessonId: "modern-cnns", section: "Convolutional vision" },
      {
        subId: "D2",
      ...
      { subId: "D2", lessonId: "sam", section: "Detection & segmentation" },
      { subId: "D2", lessonId: "vit", section: "Transformers & rendering" },
      {
        subId: "D2",
        lessonId: "neural-rendering",
        section: "Transformers & rendering",
      },
      {
        subId: "D5",
        lessonId: "contrastive-ssl",
        section: "Self-supervised & multimodal",
      },
      {
        subId: "D5",
      ...
      { subId: "D5", lessonId: "mim", section: "Self-supervised & multimodal" },
      {
        subId: "E7",
        lessonId: "clip",
        section: "Self-supervised & multimodal",
  ...
  },
  {
    ...
    steps: [
      ...
      { subId: "C1", lessonId: "ridge-regression", section: "Linear models" },
      { subId: "C1", lessonId: "lasso", section: "Linear models" },
      { subId: "C3", lessonId: "decision-trees", section: "Trees & boosting" },
      { subId: "C3", lessonId: "bagging-rf", section: "Trees & boosting" },
      {
        subId: "C3",
        lessonId: "gradient-boosting",
        section: "Trees & boosting",
      },
      {
        subId: "C3",
      ...
      },
      {
        ...
        section: "Kernels & instance",
      },
      { subId: "C2", lessonId: "kernel-trick", section: "Kernels & instance" },
      { subId: "C4", lessonId: "knn", section: "Kernels & instance" },
      { subId: "C4", lessonId: "naive-bayes", section: "Kernels & instance" },
      { subId: "C5", lessonId: "kmeans", section: "Unsupervised learning" },
      { subId: "C5", lessonId: "gmm-em", section: "Unsupervised learning" },
      { subId: "C5", lessonId: "tsne-umap", section: "Unsupervised learning" },
      {
        subId: "C7",
